...
function validateParameters(
    ...
    if (
        ...
        throw new TypeError(
            "Share count must be an integer."
        );
    ...
    if (
        ...
        throw new Error(
            "Threshold cannot be greater than share count."
        );
...
function normalizeShare(
    ...
    if (
        ...
        throw new Error(
            "Share ID must be an integer between 1 and 255."
        );
    ...
    if (
        ...
        throw new Error(
            "Share value must be a Base64 string."
        );
...
function combineShares(
    ...
    if (
        ...
        throw new TypeError(
            "Shares must be provided as an array."
        );
